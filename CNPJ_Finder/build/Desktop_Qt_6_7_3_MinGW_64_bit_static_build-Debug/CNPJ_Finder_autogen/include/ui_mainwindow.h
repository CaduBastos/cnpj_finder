...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cnpj_fields->setFrameShape(QFrame::Shape::Box);
        cnpj_fields->setFrameShadow(QFrame::Shadow::Raised);
        ...
        group_location->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        group_contact->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        company_informations->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_fake_name->setGeometry(QRect(17, 81, 80, 20));
