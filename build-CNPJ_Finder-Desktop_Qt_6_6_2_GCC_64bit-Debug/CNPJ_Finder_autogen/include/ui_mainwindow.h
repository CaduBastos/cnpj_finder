...
public:
    ...
    QAction *actionHistorico;
    QAction *actionInforma_oes;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionHistorico = new QAction(MainWindow);
        actionHistorico->setObjectName("actionHistorico");
        actionInforma_oes = new QAction(MainWindow);
        actionInforma_oes->setObjectName("actionInforma_oes");
        ...
        QIcon icon(QIcon::fromTheme(QString::fromUtf8("edit-paste")));
        ...
        group_location->setGeometry(QRect(20, 200, 461, 271));
        ...
        group_contact->setGeometry(QRect(540, 220, 461, 111));
        ...
        company_informations->setGeometry(QRect(440, 10, 691, 181));
        ...
        group_qsa->setGeometry(QRect(540, 360, 521, 251));
        ...
        menuArquivo->addAction(actionHistorico);
        menuArquivo->addAction(menuTema->menuAction());
        menuArquivo->addAction(actionInforma_oes);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionHistorico->setText(QCoreApplication::translate("MainWindow", "Historico", nullptr));
        actionInforma_oes->setText(QCoreApplication::translate("MainWindow", "Sobre", nullptr));
